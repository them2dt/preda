...
export default function SidePanel({
  ...
  return (
    <>
        ...
        <div className="sidepanel flex-column-between-center">
          <div className="flex-column-start-center">
            <div className="logo-box flex-row-center-center">
              ...
              <div className="naming flex-column-start-start">
                <div className=" variant font-h3">Preda</div>
                <div className="name font-text-tiny">by Emptea Studios</div>
              </div>
            </div>
      ...
      <div
        className="navbar flex-row-between-center"
        data-theme={themes[theme]}
      >
        <Image src={Logo} alt="Preda" />
        <Link
      ...
      {menu && (
        <div
          className={"mobile sidepanel-container flex-row-end-end"}
          data-theme={themes[theme]}
        >
          <div className="sidepanel flex-column-between-center">
            <div className="flex-column-start-center">
