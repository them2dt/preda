...
import { Signal, TextField } from "./TeaUI";
      ...
      >
        ...
        {navModal == 2 && (
          ...
          >
            ...
            >
              <div
                className="rpc-option flex-row-start-center"
                onClick={() => {}}
              >
                <Signal state={false} />
                Mainnet
              ...
              <TextField label={"Custom RPC"} setValue={(i: string) => {}} />
              <div
                className="submit button font-text-bold flex-row-center-center"
                onClick={() => {
                  toggleTheme(3);
                }}
              >
