...
import solana from "../media/solana.svg";
...
export default function Page() {
  ...
  return (
    <>
      <Header id={0} theme={0} themes={themes} />

      <div className="homepage flex-column-center-center">
        <div className="section hero flex-column-center-center">
        ...
        <div id="tools" className="section tools flex-column-center-center">
          ...
          <div className="cards flex-row-center-center">
              ...
              >
                <div className="card-base flex-column-center-center">
                  <div className="info flex-column-center-start">
                    ...
                    <div className="description font-text">
                      Programmable NFT to integrate rules like enforced
                      royalties.
                    </div>
                  </div>
                  <div className="actions flex-column-center-center">
              ...
              >
                <div className="card-base flex-column-center-center">
                  <div className="info flex-column-center-start">
                    ...
                    <div className="description font-text">
                      Compression allows you to mint more than a million NFTs
                      for 100$.
                    </div>
                  </div>
                  <div className="actions flex-column-center-center">
              ...
              >
                <div className="card-base flex-column-center-center">
                  <div className="info flex-column-center-start">
                    ...
                    <div className="description font-text">
                      The standard for advanced operations, like token
                      extensions.
                    </div>
                  </div>
                  <div className="actions flex-column-center-center">
            ...
            {advanced && (
              <motion.div
                className="card core flex-column-center-center"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                transition={{ delay: 0.3, duration: 0.1 }}
              >
                <div className="card-base flex-column-center-center">
                  <div className="info flex-column-center-start">
                    <div className="standard font-h4">CORE</div>
                    <div className="description font-text">
                      The newest innovation, designed to create your digital
                      asset with custom plugins.
                    </div>
                  </div>
                  <div className="actions flex-column-center-center">
        ...
        <div id="powered" className="section flex-column-center-center">
          ...
          <div className="components flex-row-center-center">
            <Image src={solana} alt="components" height={50} />
